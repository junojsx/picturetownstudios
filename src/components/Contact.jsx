...
import { Mail, MapPin, Instagram, Youtube, Linkedin, Send, ArrowRight } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-12 lg:gap-20">
          ...
          <div>
            {submitted ? (
              <div className="flex flex-col gap-5 py-8">
                ...
                <h3 className="font-display text-white text-4xl">Message Received</h3>
          ...
          <div className="flex flex-col gap-8">
            <div>
              <h3 className="font-display text-white text-3xl mb-6">Direct Contact</h3>
              <div className="space-y-4">
                ...
                >
                  <div className="w-10 h-10 border border-white/10 flex items-center justify-center group-hover:border-brand-amber transition-colors duration-300">
                    <Mail size={13} className="text-brand-blue group-hover:text-brand-amber transition-colors duration-300" />
                  </div>
                  <div>
                    <p className="font-body text-[9px] tracking-widest uppercase text-brand-silver/55 mb-0.5">Email</p>
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <p className="font-body text-[9px] tracking-widest uppercase text-brand-silver/55 mb-0.5">Based In</p>
                    <p className="font-body text-brand-silver/80 text-sm">Los Angeles, CA</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-white/[0.08] p-5">
              ...
              <p className="font-body text-brand-silver/60 text-xs leading-relaxed">
                Currently accepting new projects for Q2 2026. Short-turnaround inquiries welcome.
              </p>
            </div>
          </div>
        </div>
